package com.lcb.test.formal.mvp.activity;
...
import com.lcb.test.BuildConfig;
import com.lcb.test.R;
import com.lcb.test.formal.mvp.contract.LoginContract;
import com.lcb.test.formal.mvp.presenter.LoginPresenter;
...
public class MvpLoginActivity extends AppCompatActivity implements LoginContract.IView {
    ...
    public void onClick() {
        showLoding("正在登录。。。");
        presenter.reqLogin("1311333388", "123456");
    }
