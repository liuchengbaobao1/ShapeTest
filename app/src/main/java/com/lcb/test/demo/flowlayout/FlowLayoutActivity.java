package com.lcb.test.demo.flowlayout;
...
/**
 * Created by chengbao.liu on 2019/1/2.
 */

public class FlowLayoutActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_add_random:
                ...
                tv.setLines(1);
                tv.setBackgroundResource(R.drawable.bg_flowlayout);
